...
function AddProducts() {
  ...
  function handleDelete() {
    console.log(rows.map((row) => row.selected === false ? true : false),"========");
    if(!((rows.map((row) => row.selected === false ? true : false)).includes(false))){
      handleClose()
      toast("There are no rows selected to delete")
    }
    else{
      handleClose();
